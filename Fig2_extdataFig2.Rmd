...
```
  ggplot(treated_samples[!is.na(RT) & reads_allbins>=10],aes(x = RT, y = treatment)) +
...
```
  a1<-treated_samples[treatment=="Untreated" & replicate==1 & reads_allbins>=10, c("identifier","RT", "stop_type", "down_12nt", "down_1nt")]; setnames(a1, "RT", "Untreated")
  
  a2<-treated_samples[treatment=="SRI" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a2, "RT", "SRI")
  a3<-treated_samples[treatment=="DAP" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a3, "RT", "DAP")
  a4<-treated_samples[treatment=="Clitocine" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a4, "RT", "Clitocine")
  a5<-treated_samples[treatment=="Gentamicin" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a5, "RT", "Gentamicin")
  a6<-treated_samples[treatment=="G418" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a6, "RT", "G418")
  a7<-treated_samples[treatment=="CC90009" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a7, "RT", "CC90009")
  a8<-treated_samples[treatment=="SJ6986" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a8, "RT", "SJ6986")
  a9<-treated_samples[treatment=="FUr" & replicate==1 & reads_allbins>=10, c("identifier","RT")]; setnames(a9, "RT", "FUr")
```  
...
**Fig.2d:**Stop type
```
ggplot(treated_samples[treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(stop_type), fill=treatment)) + ylim(0,4) + geom_boxplot(outlier.shape = NA) + 
...
```        
          ggplot(treated_samples[stop_type=="tga" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(down_1nt), fill=treatment)) + ylim(0,5.5) + geom_boxplot(outlier.shape = NA) + 
...
```
ggplot(treated_samples[treatment%in%c("Clitocine", "SRI") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(down_1nt), fill=treatment)) + geom_boxplot(outlier.shape = NA) + drugs_fills + labs(x="Stoptype*down_1nt interaction", y="Readthrough (%)", title="") + 
...
```
ggplot(treated_samples[stop_type=="tga" & treatment%in%c("SRI") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(down_123nt), fill=treatment)) + ylim(0,6.5) + geom_boxplot(outlier.shape = NA) + 
...
```
ggplot(treated_samples[stop_type=="tga" & treatment%in%c("SRI") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_123nt), fill=treatment)) + ylim(0,6.5) + geom_boxplot(outlier.shape = NA) + 
...
```
ggplot(treated_samples[stop_type=="tga" & up_aa=="E" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_123nt), fill=treatment)) + ylim(0,4.5) + geom_boxplot(outlier.shape = NA) + 
...
```
ggplot(treated_samples[stop_type=="tga" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & up_aa%chin%c("E", "G", "L", "K", "Q", "V", "S", "I", "R", "P", "T", "A") & replicate==1 & reads_allbins>=10], aes(y=RT, x=up_aa, fill=toupper(up_1nt))) + geom_boxplot(outlier.shape = NA) + 
...
```  
ggplot(treated_samples[stop_type=="tga" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(down_123nt), fill=treatment)) + ylim(0,6.5) + geom_boxplot(outlier.shape = NA) + 
...
``` 
ggplot(treated_samples[stop_type=="tga" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_123nt), fill=treatment)) + ylim(0,6.5) + geom_boxplot(outlier.shape = NA) + 
...
**Ext.Data.Fig.2c:**
```
ggplot(treated_samples[treatment%in%c("SJ6986", "CC90009", "FUr", "Gentamicin") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(stop_type), fill=treatment)) + ylim(0,4) + geom_boxplot(outlier.shape = NA) + 
            drugs_fills + labs(x="Stop type", y="Readthrough (%)", title="", fill="Treatment") + p + 
            theme(legend.text = element_text(size=12), legend.title = element_text(size=15), legend.position = c(.5,.95), legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55))
```
**Ext.Data.Fig.2d:**
```
          ggplot(treated_samples[stop_type=="tga" & treatment%in%c("SJ6986", "CC90009", "FUr", "Gentamicin") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(down_1nt), fill=treatment)) + ylim(0,5.5) + geom_boxplot(outlier.shape = NA) + 
            drugs_fills + labs(x="+1nt downstream the TGA PTC", y="Readthrough (%)", title="", fill="Treatment") + p + 
            theme(legend.text = element_text(size=12), legend.title = element_text(size=15), legend.position = "none", legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55))
```    
...
```
ggplot(treated_samples[treatment%in%c("G418", "SJ6986", "DAP") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(down_1nt), fill=treatment)) + geom_boxplot(outlier.shape = NA) + drugs_fills + labs(x="Stoptype*down_1nt interaction", y="Readthrough (%)", title="") + 
            theme(legend.text = element_text(size=12), legend.title=element_blank(),legend.position = c(.5,1.15), legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55)) +
            facet_wrap(~toupper(stop_type), scales = "free") + p
```
...
```
ggplot(treated_samples[stop_type=="tga" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_aa), fill=treatment)) + ylim(0,6) + geom_boxplot(outlier.shape = NA) + drugs_fills + labs(x="Aminoacid upstream of the TGA PTC", y="Readthrough (%)", title="", fill="Treatment") + p + 
    theme(legend.text = element_text(size=12), legend.title = element_text(size=15), legend.position = c(.5,.95), legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55))
```
...
```
ggplot(treated_samples[stop_type=="tga" & up_aa=="E" & treatment%in%c("SJ6986", "CC90009", "FUr", "Gentamicin") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_123nt), fill=treatment)) + ylim(0,4.5) + geom_boxplot(outlier.shape = NA) + 
            drugs_fills + labs(x="Glutamic acid upstream of the TGA PTC", y="Readthrough (%)", title="", fill="Treatment") + p + 
            theme(legend.text = element_text(size=12), legend.title = element_text(size=15), legend.position = "none", legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55))
```
...
```
ggplot(treated_samples[stop_type=="tga" & up_aa=="R" & treatment%in%c("Clitocine", "SRI", "DAP", "G418") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_123nt), fill=treatment)) + ylim(0,4.5) + geom_boxplot(outlier.shape = NA) + 
...
```
ggplot(treated_samples[stop_type=="tga" & up_aa=="R" & treatment%in%c("SJ6986", "CC90009", "FUr", "Gentamicin") & replicate==1 & reads_allbins>=10], aes(y=RT, x=toupper(up_123nt), fill=treatment)) + ylim(0,4.5) + geom_boxplot(outlier.shape = NA) + 
            drugs_fills + labs(x="Arginine upstream of the TGA PTC", y="Readthrough (%)", title="", fill="Treatment") + p + 
            theme(legend.text = element_text(size=12), legend.title = element_text(size=15), legend.position = "none", legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55))
```
...
```
 ggplot(treated_samples[stop_type=="tga" & treatment%in%c("SJ6986", "CC90009") & up_aa%chin%c("E", "G", "L", "K", "Q", "V", "S", "I", "R", "P", "T", "A") & replicate==1 & reads_allbins>=10], aes(y=RT, x=up_aa, fill=toupper(up_1nt))) + geom_boxplot(outlier.shape = NA) + 
            nts_fills + labs(x="Aminoacid upstream of the TGA PTC", y="Readthrough (%)", fill="3rd nt") + p + facet_wrap(~treatment, nrow=2, scales = "free") +
            theme(panel.spacing.y = unit(.5, "lines"), legend.text = element_text(size=12), legend.title = element_text(size=15), legend.position = "top", legend.direction="horizontal") + guides(fill = guide_legend(title.position = "top", title.hjust=.55))
```
