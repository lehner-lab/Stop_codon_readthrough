...
```
  heatmap_df<-readRDS(file = "/base_dir/Fig2/heatmap_df.rds")
```
...
**Fig.2c**: Interdrugs correlations. Load the correlations_tbl, cluster and plot the heatmap:
```
...
```
  correlations_tbl<-readRDS(file = "/base_dir/Fig2/correlations_tbl.rds")
```
