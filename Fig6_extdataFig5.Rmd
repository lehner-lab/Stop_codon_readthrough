...
```
  list2<-readRDS(file = file.path(base_dir, "Fig6_insilico_saturation_mutagenesis/list2.rds"))
  list2_dtbl<-readRDS(file = file.path(base_dir, "Fig6_insilico_saturation_mutagenesis/list2_dtbl.rds"))
```
