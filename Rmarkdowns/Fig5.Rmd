...
```
  APC_variants<-readRDS(file = "/base_dir/Fig5/APC_variants.rds")
  CFTR_variants<-readRDS(file = "/base_dir/Fig5/CFTR_variants.rds")
  DMD_variants<-readRDS(file = "/base_dir/Fig5/DMD_variants.rds")
